...
**Answer** The columns show each candidate and their total voters per each jurisdiction. Instead of a nested list, the results are now shown as a dataframe. 
...
**Answer** The numbers 2 through 6 correspond with the number of each column. For example, harris is column number 2 and trump is column number 3. 
...
**Answer**The output suggests that there are 54 li tags. 
...
**Answer**The output shows the text inside each <li> tag. It only shows what readers can see listed on the site. 
...
**Answer** The output is a dataframe that contains only the committee names and their urls. 
