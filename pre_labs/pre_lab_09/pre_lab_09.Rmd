...
https://datawrapper.dwcdn.net/h1LOs/1/
...
**Answer** Compared to the previous map, we now see the state of Maryland zoomed in. All other parts of the U.S. are cut out of the map. 
 ...
 **Answer** The map now shows the name of the county along with the percentage of votes that Moore recieved in the election per each county. There is also a title and description so readers get an understanding of what the map is showing. 
...
https://datawrapper.dwcdn.net/1ShTY/1/
