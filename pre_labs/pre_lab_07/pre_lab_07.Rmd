...
Nevada has the largest percentage growth. 
...
No, the difference between Calvert and Montgomery is not significant. 

Is the difference between Howard and everyone else significant? **Answer**

Yes, the difference between Howard and everywhere else is significant. 
...
Yes, Montgomery County had their median incomes fall the change is not outside the margin of error. 
...
**Answer** 1 zipcode has an estimated household income of less than $50,000. 
...
How does the cost of living compare to other zip codes/how do housing prices compare in these areas? What industries contribute to these household incomes? 
