...
**Answer**The dataframe displays dates, titles, urls and text from websites. 
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** The unique function prints each word once. 
...
**Answer**The function created a dataframe that holds all the words from the text. 
...
**Answer** The graphic shows unique words found in the releases - showing only the top 25 words. It could be more interesting, I don't think this graph is showing us any words of substance. 
...
**Answer**Yes, there are now percents of words along with more interesting words from the text. 
...
**Answer**The output shows words along with their amounds and percents shown in the text. 
...
**Answer**The dataframe shows a bigram, along with the amount they are shown and their percents. 
...
**Answer**The dataframe shows the top 10 phrases for 2024 shown in the text, with health care being number one. It also shows the amount and percent of each word. 
...
**Answer**The first one - the second output shows the word drive five times, instead of using different tenses. 
...
**Answer**The first result has different top results, I think the first result is more useful based on the percentages given. 
...
**Answer** The results show the word, sentiment, and word count. Most of the sentiments seem correct. 
